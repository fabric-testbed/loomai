# Create a Wide-Area Ethernet (Layer 2) Network: Automatic IP Configuration
# Source: FABRIC Jupyter Examples - fablib_api
# Notebook: create_l2network_wide_area_auto.ipynb
#
# This notebook demonstrates how to create an isolated Layer 2 Ethernet network
# that **spans two different FABRIC sites**, using FABlib's automatic IP
# configuration. FABRIC provisions a dedicated Eth...
