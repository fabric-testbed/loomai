# Create a Local Ethernet (Layer 2) Network: User-Defined IP Configuration
# Source: FABRIC Jupyter Examples - fablib_api
# Notebook: create_l2network_basic_config.ipynb
#
...
# user-defined (`config`) IP mode. With this appr...
...
# ### How User-Defined Configuration Works
