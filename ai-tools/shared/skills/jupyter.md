...
as artifacts appear in the WebUI Artifacts panel and can be opened in JupyterLab.
...
5. **Save** the `.ipynb` file to `$ARTIFACTS_DIR/<Notebook_Name>/`.
   The notebook appears in the WebUI Artifacts panel immediately.

6. **Open in JupyterLab**: Start JupyterLab via
